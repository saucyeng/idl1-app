...
describe("settingsBackend — write()", () => {
  ...
  it("write() also persists the whole document locally", async () => {
    ...
    expect(stored.ui).toEqual({ last_section: "sync", section_list_width_px: 260, theme: "dark", output_register: null, paper_theme: "app", firmware_repo: "", firmware_channel: "stable", graph_node_colour: false });
