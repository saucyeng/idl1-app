...
Repo `idl1-app`, submodule `rust/` = idl-rs at `c893ba7`. Worktree `saucyeng/idl-rs-worktrees/wave3-l2b-laps`, branch `wave3-l2b-laps`. Eight tasks, serial, one cargo process. Gates after T4 and at the lane merge.
